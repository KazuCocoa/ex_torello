defmodule ExTrello.BoardChannel do
  @moduledoc """
  Board channel
  """
  ...
  alias ExTrello.{User, Board, UserBoard, List, Card, Comment, CardMember}
  alias ExTrello.BoardChannel.Monitor
    ...
    try do
      ...
      case Repo.insert(changeset) do
        {:ok, _board_user} ->
          ...
          ExTrello.Endpoint.broadcast_from! self(), "users:#{user.id}", "boards:add", %{board: board}
